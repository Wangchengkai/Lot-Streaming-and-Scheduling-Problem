...
int useMachineLearningResultToControlArcs = 0;
...
int duqu()
{
	...
	for (int n = 0; n <= NN; n++)cout << " "<<n<<" (): " << LAT[0][n] << endl;
...
double min_label_real_time_U(double* a1, double* b1)
{
	...
	for (int n = 0; n <= NN; n++)cout << "label " << n << " : " << LAT[counti][n] << endl;
	cout << "the max number of label: " << maxcaseused + 1 << "" << endl;
...
double min_label_real_time(double* a1, double* b1)
{
	...
	cout << "min real time: " << temp << endl;
	cout << "the optimal label is the  " << counti << " -th one" << endl;
	cout << "save at most " << maxcaseused + 1 << " label in the process" << endl;
...
double min_label_real_time_E(double* a1, double* b1)
{
	...
	cout << "the best label is the " << counti << " -th label" << endl;
	...
	sublot_size(temp2, a1, b1);
	cout << "the optimal sublot result" << endl;
	for (int a = 1; a < 50; a++)
	{
		cout << seq[a] << ",";
	}
...
int main_OutData(int argc, char* argv[])
{
	d[1] = atoi(argv[1]);
	d[2] = atoi(argv[2]);
	d[3] = atoi(argv[3]);
...
int main(int argc, char* argv[])
{
	...
	for (int counti = 0; counti <= 0; counti++)
	{
		...
		usefulArcRead.clear();
		string file_train_save = "20231020/predEXP20231020_" + to_string(index) + ".csv";
